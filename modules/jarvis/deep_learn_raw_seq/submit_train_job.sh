...
echo "Training JARVIS for $genomic_classes using 'structured' features..."
...
echo "Training JARVIS for $genomic_classes using 'sequences' features..."
...
echo "Training JARVIS for $genomic_classes using 'both' features..."

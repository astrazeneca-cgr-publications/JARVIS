...
if 0:
	...
	a = ubiq_lower_bottom_df['gwrvis']
	b = ubiq_upper_top_df['gwrvis']
	#a = lower_bottom_df['gwrvis']
	#b = upper_top_df['gwrvis']

	res = mannwhitneyu(a, b)
	print('\n\nUbiquitous Lower ' + str(top_percentile) + '% vs Higher ' + str(top_percentile) + '% of Enhancer gwRVIS scores:')
...
ubiq_phantom_df = pd.read_csv(ubiq_phantom5_file, header=None, sep='\t')
print(ubiq_phantom_df.head())
ubiq_phantom_df.columns = ['chr', 'start', 'end', 'gwrvis']
print(ubiq_phantom_df.head())

non_ubiq_phantom_df = pd.read_csv(non_ubiq_phantom5_file, header=None, sep='\t')
non_ubiq_phantom_df.columns = ['chr', 'start', 'end', 'gwrvis']
print(non_ubiq_phantom_df.head())

a = ubiq_phantom_df['gwrvis']
b = non_ubiq_phantom_df['gwrvis']
...
ubiq_lower_bottom_df.columns = ['chr', 'start', 'end', 'gwrvis']
...
ubiq_upper_top_df = pd.read_csv(ubiq_upper_top_file, header=None, sep='\t')
ubiq_upper_top_df.columns = ['chr', 'start', 'end', 'gwrvis']
